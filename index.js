...
function startServer(port) {
    dispatcher.onGet('/download', function (req, res) {
        ...
        if (downloadOrNot() && ID !== null && (parseInt(returnIdParam(req)) !== parseInt(ID)) && !downloadedIDs.includes(parseInt(returnIdParam(req)))) {
    ...
    dispatcher.onPost('/file', function (req, res) {
        ...
        if (postId !== null && postId in unhandledResponses && ID !== null && (parseInt(returnIdParam(req)) !== parseInt(ID))) {
            ...
            console.log('yayy minu request saadeti tagasiiiii', req.body);
            ID = null;
        } else {
